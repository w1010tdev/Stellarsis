...
StellarSIS（星际信息系统）是一个功能丰富的在线社区平台，集成了聊天、论坛、用户管理等多种功能。该系统为用户提供了一个安全、高效、可扩展的交流环境，支持多房间聊天、分区论坛、用户关注等功能。

## 功能总览

StellarSIS 提供了以下主要功能：

- **用户认证系统**：安全的登录/登出、密码修改、个人资料设置
- **聊天系统**：多房间实时聊天，支持 Markdown 格式消息
- **论坛系统**：分区论坛，支持主题帖和回复
- **用户关注系统**：关注特定用户，接收上线通知
- **权限管理系统**：细粒度的用户权限控制
- **管理员面板**：完整的用户、聊天、论坛管理功能
- **文件管理**：管理员可以管理服务器文件
- **在线状态监控**：实时显示在线用户数和用户列表
